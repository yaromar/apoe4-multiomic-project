...
├── notebooks/
│   ├── 01_pheno_exploration_and_heatmaps.Rmd
│   ├── 02_epigenetic_biomarker_associations.Rmd
│   ├── 03_ewas_AD_status.Rmd
│   ├── 04_wgcna_DNAm_modules.Rmd
│   ├── 10_proteomics_import_and_cleaning.Rmd
│   ├── 11_proteomics_normalization_and_integration.Rmd
│   ├── 12_proteomics_ruv_normalization_and_differential.Rmd
│   ├── 20_methylation_interactions_and_mediation.Rmd
...
│   ├── 03_cleanup_lanes_and_empty_dirs.sh
│   ├── 04_quip_to_gz.slurm
│   ├── 05_fastqc_raw.slurm
│   ├── 06_multiqc_raw_QC.sh
│   ├── 07_cleanup_fastqc_reports.sh
│   ├── 08_trimgalore.slurm
│   ├── 09_fastqc_posttrim.slurm
│   ├── 10_multiqc_posttrim_QC.sh
│   ├── 11_cleanup_intermediate_fastq.sh
│   ├── 12_compute_read_length_stats.slurm
│   ├── 13_build_decoy_reference.sh
│   ├── 14_bwa_align_and_target_filter.slurm
│   ├── 15_sort_bam_with_picard.slurm
│   ├── 16_merge_lanes_bam_with_picard.slurm
│   ├── 17_mark_duplicates.slurm
│   ├── 18_collect_alignment_metrics.slurm
│   ├── 19_base_recalibration.slurm
│   ├── 20_apply_bqsr.slurm
│   ├── 21_get_pileups_and_contamination.slurm
│   ├── 22_mutect2_calling.slurm
│   ├── 23_learn_read_orientation_and_sort_vcf.slurm
│   ├── 24_filter_mutect_calls.slurm
│   ├── 25_filter_variants_keep_pass.sh
│   ├── 26_snpeff_annotation.slurm
