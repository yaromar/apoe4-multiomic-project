...
│   ├── 07_trimgalore.slurm
│   ├── 08_fastqc_posttrim.slurm
│   ├── 9_multiqc_posttrim_QC.sh
│   ├── 10_cleanup_intermediate_fastq.sh
│   ├── 11_compute_read_length_stats.slurm
│   ├── 12_build_decoy_reference.sh
│   ├── 13_bwa_align_and_target_filter.slurm
│   ├── 14_sort_bam_with_picard.slurm
│   ├── 15_merge_lanes_bam_with_picard.slurm
│   ├── 16_mark_duplicates.slurm
│   ├── 17_collect_alignment_metrics.slurm
│   ├── 18_base_recalibration.slurm
│   ├── 19_apply_bqsr.slurm
│   ├── 20_get_pileups_and_contamination.slurm
│   ├── 21_mutect2_calling.slurm
│   ├── 22_learn_read_orientation_and_sort_vcf.slurm
│   ├── 23_filter_mutect_calls.slurm
│   ├── 24_filter_variants_keep_pass.sh
│   ├── 25_snpeff_annotation.slurm
│   ├── 26_snpsift_annot_and_genesets.slurm
│   ├── 27_bgzip_and_tabix_vcfs.sh
│   ├── 28_merge_sample_vcfs.sh
