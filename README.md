...
│   ├── 08_build_decoy_reference.sh
│   ├── 09_bwa_align_and_target_filter.sh
│   ├── 10_sort_bam_with_picard.sh
│   ├── 11_merge_lanes_bam_with_picard.sh
│   ├── 12_mark_duplicates.sh
│   ├── 13_collect_alignment_metrics.sh
│   ├── 14_base_recalibration.sh
│   ├── 15_apply_bqsr.sh
│   ├── 16_get_pileups_and_contamination.sh
│   ├── 17_mutect2_calling.sh
│   ├── 18_learn_read_orientation_and_sort_vcf.sh
│   ├── 19_filter_mutect_calls.sh
│   ├── 20_filter_variants_keep_pass.sh
│   ├── 21_snpeff_annotation.sh
│   ├── 22_snpsift_annot_and_genesets.sh
│   ├── 23_bgzip_and_tabix_vcfs.sh
│   ├── 24_merge_sample_vcfs.sh
